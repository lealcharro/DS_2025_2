Capturas de pantalla del despligue en base a la solución, en el archivo .sh de la actividad 2, ejecutarlo de manera local, respondiendo las preguntas y con capturas de pantallas
